  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <motion.div className="mb-8 inline-flex items-center justify-center" initial={{
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
          ...
          delay: 0.1,
          ease: "easeOut"
        }}>Automate Smarter. Grow    Faster. with AI<span className="bg-gradient-accent bg-clip-text text-transparent">Grow </span> <span className="bg-gradient-accent bg-clip-text text-transparent">Assistants</span> in Minutes
          </motion.h1>
          ...
          <motion.a href="https://platform.spotzyai.com" className="inline-flex items-center gap-3 px-8 py-4 glass-card rounded-full mb-10 cursor-pointer group" initial={{
          opacity: 0,
          scale: 0.95
        }} animate={{
          opacity: 1,
