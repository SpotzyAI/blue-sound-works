...
const Restaurant = () => {
  const features = [{
    ...
    items: ["Make new reservations with real-time availability", "Cancel existing reservations instantly", "Modify previous bookings", "Handle special requests & dietary requirements"]
  }, {
    icon: MessageSquare,
    title: "Automated Communications",
    items: ["Reservation confirmations", "Appointment reminders", "Thank you follow-ups", "Birthday reminders", "Custom automated messages"],
    note: "Extra SMS automations beyond package = €20/month per 100 messages"
  }, {
    icon: TrendingUp,
    title: "Operational Excellence",
    items: ["Provide restaurant information", "Answer frequently asked questions", "Reduce staff workload by 70%", "24/7 availability"]
  }];
  const useCases = [{
    title: "Peak Hours Booking",
    conversation: [{
      speaker: "Customer",
      message: "Hi, I need a table for 4 tonight at 7pm"
    }, {
      speaker: "AI",
      message: "Let me check our real-time availability... I have 7pm or 7:30pm available. Which works better for you?"
    }]
  }, {
    title: "Modification Request",
    conversation: [{
      speaker: "Customer",
      message: "I need to change my reservation from 6 to 8 people"
    }, {
      speaker: "AI",
      message: "I've verified availability and updated your reservation for 8 guests. You'll receive a confirmation SMS shortly!"
    }]
  }, {
    title: "Cancellation & Rebooking",
    conversation: [{
      speaker: "Customer",
      message: "I need to cancel my 8pm reservation"
    }, {
      speaker: "AI",
      message: "Your reservation has been cancelled. The slot is now available for other guests. Would you like to rebook for another time?"
    }]
  }];
  const beforeAfter = [{
    before: "Missed calls during busy hours",
    after: "Never miss a reservation",
    icon: Phone
  }, {
    before: "Double bookings and errors",
    after: "Zero booking errors",
    icon: Calendar
  }, {
    before: "Staff overwhelmed with phone calls",
    after: "Staff focuses on guests",
    icon: Users
  }, {
    before: "No availability info during calls",
    after: "Instant availability confirmation",
    icon: Clock
  }, {
    before: "Manual reservation management",
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {features.map((feature, index) => <div key={index} className="p-6 rounded-2xl bg-card border border-border shadow-soft">
                  ...
                  {feature.note && <div className="mt-4 p-3 rounded-lg bg-muted/50 border border-border">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="p-8 rounded-2xl bg-card border border-border shadow-soft">
                ...
                <ul className="space-y-4">
                  {["Real-time reservation view", "Table management", "Customer database", "Analytics & insights", "Mobile-friendly design", "Easy-to-use interface"].map((item, idx) => <li key={idx} className="flex items-start gap-3">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {useCases.map((useCase, idx) => <div key={idx} className="p-6 rounded-2xl bg-card border border-border shadow-soft">
                  ...
                  <div className="space-y-4">
                    {useCase.conversation.map((msg, msgIdx) => <div key={msgIdx} className={`p-4 rounded-xl ${msg.speaker === "Customer" ? "bg-muted" : "bg-primary/10 border border-primary/20"}`}>
